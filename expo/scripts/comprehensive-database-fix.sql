...
-- This script fixes all database issues including foreign key constraints and missing columns
...
-- 3. Create function to ensure all auth users have profiles
...
-- 4. Ensure goals table exists and has correct structure
...
-- 5. Drop and recreate tasks table to ensure correct structure
...
-- 9. Create RLS policies for goals
...
-- 10. Create RLS policies for tasks
...
-- 11. Create or replace updated_at trigger function
...
-- 15. Force refresh the schema cache
NOTIFY pgrst, 'reload schema';

-- 16. Test the setup with actual data
DO $$
DECLARE
    test_user_id UUID;
    test_goal_id UUID;
...
BEGIN
    ...
    IF test_user_id IS NOT NULL THEN
        ...
        VALUES (test_user_id, 'Test Goal - Comprehensive Fix', 'Testing comprehensive database setup')
        ...
        VALUES (test_user_id, test_goal_id, 'Test Task - Comprehensive Fix', 'Testing completed column and all fields', false, 'medium', 30, false, 0)
...
SELECT 'COMPREHENSIVE DATABASE FIX COMPLETED SUCCESSFULLY!' as final_status;